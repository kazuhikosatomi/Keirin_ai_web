...
def main(target_date):
    # 入力ファイルパス（Step5の予測結果）
    input_path = Path(f"data/2nd/step5/step5_predicted_rank_{target_date}.csv")
    output_path = Path(f"output/predict/csv/2nd/final_prediction_niren_{target_date}.csv")
