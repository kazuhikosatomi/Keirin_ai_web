...
TRAIN_FILE = Path("data/2nd/tmp/step2_train_racer_level.csv")
MODEL_PATH = Path("data/2nd/tmp/step3_rank_model.pkl")
...
# CSVで保存
importance_df.to_csv("data/2nd/tmp/step3_feature_importance.csv", index=False)

# 重要度グラフ（任意）
plt.figure(figsize=(10, 6))
lgb.plot_importance(model, max_num_features=20)
plt.tight_layout()
plt.savefig("data/2nd/tmp/step3_feature_importance.png")
plt.close()