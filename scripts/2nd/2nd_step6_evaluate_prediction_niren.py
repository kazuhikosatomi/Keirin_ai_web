...
pred_path = f"data/2nd/step5/step5_predicted_rank_{target_date}.csv"
...
# ✅ 保存
import os
os.makedirs("data/2nd/step6", exist_ok=True)

output_path = f"data/2nd/step6/step6_evaluation_niren_{target_date}.csv"
