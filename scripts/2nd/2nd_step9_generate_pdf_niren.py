...
def main(date_str):
    input_path = Path(f"output/predict/csv/2nd/final_prediction_niren_{date_str}.csv")
    output_path = Path(f"docs/predict/pdf/2nd/final_prediction_niren_{date_str}.pdf")
