...
entry_path = f"data/4th/tmp/step4_entry_with_features.csv"
output_path = f"data/4th/tmp/step5_predicted_rank.csv"
model_path = f"data/4th/tmp/step3_rank_model.pkl"
