...
pred_df = pd.read_csv(f"data/3rd/step5_predicted_rank_{target_date}.csv")
...
# Suppressed DeprecationWarning for now; revisit if future pandas changes break this.
...
# ✅ 保存
output_path = f"data/3rd/step6_evaluation_with_odds_{target_date}_niren.csv"
