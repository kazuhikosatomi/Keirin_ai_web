...
pred_path = f"data/6th/tmp/step5_predicted_rank.csv"
...
# ✅ 保存
import os
os.makedirs("data/6th/step6", exist_ok=True)

output_path = f"data/6th/step6/step6_evaluation_niren_{target_date}.csv"
