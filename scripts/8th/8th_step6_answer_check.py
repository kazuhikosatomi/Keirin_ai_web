...
# ファイルパス
pred_path = Path(f"data/8th/step4/predictions_{target_date}.csv")
label_path = Path(f"data/8th/step5/label_{target_date}.csv")
output_path = Path(f"data/8th/step6/feedback_{target_date}.csv")
