...
###############################################################################
# 7. 学習データ生成（前日まで）
#/Users/satomi/Documents/keirin/venv_shared/bin/python3 /Users/satomi/Documents/keirin/GitHub/Keirin_ai_web/scripts/train/generate_train_racer_level.py --start_date 2015-01-01 --end_date 2025-06-04 \
...
# 9. 特徴量生成（当日）
/Users/satomi/Documents/keirin/venv_shared/bin/python3 /Users/satomi/Documents/keirin/GitHub/Keirin_ai_web/scripts/predict/generate_predict_features.py --date 2025-06-05 \
  && echo "[OK] predict features generation completed" || echo "[FAIL] predict features generation failed"

# 10. 順位予測（当日）
/Users/satomi/Documents/keirin/venv_shared/bin/python3 /Users/satomi/Documents/keirin/GitHub/Keirin_ai_web/scripts/predict/predict_rank.py --date 2025-06-05\
