...
###############################################################################
# 6. 学習データ生成（前日まで）
/Users/satomi/Documents/keirin/venv_shared/bin/python3 /Users/satomi/Documents/keirin/GitHub/Keirin_ai_web/scripts/train/generate_train_racer_level.py --start_date 2025-01-01 --end_date 2025-06-03 \
  && echo "[OK] train racer level data generated" || echo "[FAIL] train racer level generation failed"

# 7. モデル学習（前日まで）
/Users/satomi/Documents/keirin/venv_shared/bin/python3 /Users/satomi/Documents/keirin/GitHub/Keirin_ai_web/scripts/train/train_rank_model.py --train_until 2025-06-03 \
  && echo "[OK] rank model training completed" || echo "[FAIL] rank model training failed"

# 8. 特徴量生成（当日）
/Users/satomi/Documents/keirin/venv_shared/bin/python3 /Users/satomi/Documents/keirin/GitHub/Keirin_ai_web/scripts/predict/generate_predict_features.py --date 2025-06-04 \
  && echo "[OK] predict features generation completed" || echo "[FAIL] predict features generation failed"

# 9. 順位予測（当日）
/Users/satomi/Documents/keirin/venv_shared/bin/python3 /Users/satomi/Documents/keirin/GitHub/Keirin_ai_web/scripts/predict/predict_rank.py --date 2025-06-04 \
